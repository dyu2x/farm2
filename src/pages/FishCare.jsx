...
import { Fish, Calendar, User, ArrowRight, Search, Archive } from 'lucide-react';
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen">
      <div className="relative h-[35vh] min-h-[250px] overflow-hidden">
        <img src="https://media.base44.com/images/public/6aa5c999e92256d6cdf3ef15/fe3d03beb_generated_image.png" alt="Fish Care" className="w-full h-full object-cover" />
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-2">{t('fishCare')}</h1>
          <p className="text-slate-200 max-w-xl">Expert guides on hito care, hatchery management, and sustainable aquaculture</p>
        </div>
      </div>
  ...
  return (
    <article className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg overflow-hidden border border-slate-200 dark:border-slate-700 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        {article.video_url && (
          <a href={article.video_url} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-sm text-blue-600 dark:text-cyan-400 hover:underline mb-3">
            🎥 Watch Video
          </a>
        )}
        <button
